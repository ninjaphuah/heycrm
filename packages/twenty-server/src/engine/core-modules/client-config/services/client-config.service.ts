...
export class ClientConfigService {
  ...
  async getClientConfig(): Promise<ClientConfig> {
    ...
    const clientConfig: ClientConfig = {
      ...
      productName: this.twentyConfigService.get('PRODUCT_NAME') || 'HeyCRM',
      productLogoUrl: this.twentyConfigService.get('PRODUCT_LOGO_URL'),
      productFaviconUrl: this.twentyConfigService.get('PRODUCT_FAVICON_URL'),
      billing: {
